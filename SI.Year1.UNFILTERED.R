...
taxa_EAS <- c("Epeorus", "Stenonema", "Neophylax", "Glossosoma", "Goera", 
              "Optioservus", "Ectopria", "Oulimnius", "Psephenus", "Stenelmis",
              "Paracapnia", "Leuctra", "Tallaperla", "Pteronarcys", "Amphinemura", 
              "Limoniidae", "Micrasema", "Prostoia", "Molophilus", "Hydatophylax")

taxa_FRY <- c("Goera", "Glossosoma", "Stenonema", "Epeorus", "Neophylax", 
              "Stenelmis", "Oulimnius", "Ectopria", "Psephenus", "Optioservus", 
              "Limnephilidae", "Molophilus", "Tallaperla", "Lepidostoma", 
              "Pycnopsyche", "Leuctra", "Tipula", "Pteronarcys", "Amphinemura", 
              "Prostoia")

taxa_RIC <- c("Glossosoma", "Neophylax", "Epeorus", "Stenonema", "Optioservus", 
              "Oulimnius", "Psephenus", "Ectopria", "Stenelmis", "Taeniopteryx", 
              "Leuctra", "Amphinemura", "Tipula", "Paracapnia", "Tallaperla",
              "Pycnopsyche", "Lepidostoma", "Molophilus", "Hydatophylax")
